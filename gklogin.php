...
if ($conn->connect_error) {
    ...
    // Login functionality
    $check_stmt = $conn->prepare("SELECT * FROM gk WHERE username = ? AND password = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        header("refresh:3; url=http://localhost/AWTL1/gkquiz.html");
    } 
    else 
    {
        echo "Incorrect User name or Password! Please try again...";
        header("refresh:3; url=http://localhost/AWTL1/gklogin.html");
    }
